    ...
    <section id="testimonials" className="bg-white py-24">
      <div className="container mx-auto max-w-5xl px-6">
        ...
        <p className="mb-16 text-center text-lg text-gray-600">
          Real stories from teams who streamlined their workflow.
        </p>
      </div>
      ...
      <div
        className="
          ...
          after:absolute after:right-0 after:top-0 after:z-10 after:h-full after:w-24
          after:bg-linear-to-l after:from-white after:to-transparent
        "
      >
        <div
          className="
            flex flex-nowrap space-x-8
