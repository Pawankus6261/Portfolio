...
import chatflow from "../assets/chatflow.png";
import vaitra from "../assets/vaitra.png";
...
const projects = [
  {
    id: 1,
    title: "ChatFlow.AI",
    description: "An intelligent chatbot SaaS platform for businesses to create, customize, and integrate chat assistants effortlessly.",
    image: chatflow, 
    tags: ["React", "Flask", "MongoDB", "OpenAI API"],
    category: "Full-stack",
    liveUrl: "https://chatflow-ai-web.vercel.app",
    githubUrl: "https://github.com/Pawankus6261/ChatFlow-AI",
  },
  {
    id: 2,
    title: "Vaitra",
    description: "A smart healthcare web platform featuring doctor listings, appointment booking, medicine availability, and patient dashboards.",
    image: vaitra,
    tags: ["React", "Flask", "PostgreSQL", "REST API"],
    category: "Full-stack",
    liveUrl: "https://vaitra.vercel.app",
    githubUrl: "https://github.com/Pawankus6261/Vaitra",
  },
  {
    id: 3,
    title: "AVTAAR 3D",
    description: "A futuristic 3D asset platform built for game developers, animators, and digital artists to explore and share models.",
    image: avtaar, // Fixed: matched the import name
    tags: ["React", "Three.js", "Tailwind", "3D Viewer"],
    category: "Frontend",
    liveUrl: "https://pawankus6261.github.io/Avtaar3d-",
    githubUrl: "https://github.com/Pawankush6261/avtaar-3d",
  },
  {
    id: 4,
    title: "Journal Editor",
    description: "An advanced online writing platform like Google Docs, featuring autosave, export options, and user profiles.",
    image: journal, // Updated to use local asset
  ...
  },
  {
    ...
    description: "A personal portfolio crafted with elegant animations and responsive design to showcase my work and achievements.",
    image: portfolio, // Updated to use local asset
    tags: ["React", "Tailwind CSS", "Framer Motion"],
    category: "Frontend",
    liveUrl: "https://pawan-portfolio-graphic.vercel.app/",
